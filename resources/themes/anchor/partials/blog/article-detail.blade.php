...
<div class="bg-[#fffafb] min-h-screen font-['Inter'] py-12 md:py-16">
    <x-container>
        <a href="{{ $backHref }}" wire:navigate class="inline-flex items-center gap-2 text-sm font-semibold text-[#575e75] hover:text-[#df1c24] mb-8 transition-colors">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            <div class="lg:col-span-8 flex flex-col gap-6">
                <div class="relative overflow-hidden rounded-3xl border border-[#E9E9E8] bg-white shadow-sm aspect-[16/9]">
                    ...
                    <div class="absolute inset-x-0 bottom-0 p-6 md:p-8 text-white">
                        <div class="flex flex-wrap items-center gap-2 mb-4">
                            <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/15 backdrop-blur-md border border-white/20 text-[11px] font-bold uppercase tracking-[0.16em]">
                                {{ $categoryLabel }}
                            </span>
                            <span class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/15 text-[11px] font-bold uppercase tracking-[0.16em]">
                ...
                <div class="rounded-3xl border border-[#E9E9E8] bg-white shadow-sm p-6 md:p-8">
                    <div class="flex flex-wrap gap-3 mb-6">
                        <div class="inline-flex items-center gap-2 rounded-full border border-[#E9E9E8] bg-[#f8fafc] px-4 py-2 text-xs font-semibold text-[#37352F]">
                    ...
                    <div class="prose prose-zinc max-w-none text-[#575e75] prose-headings:text-[#37352F] prose-headings:font-semibold prose-a:text-[#df1c24] prose-strong:text-[#37352F] prose-img:rounded-2xl prose-img:shadow-sm leading-[1.8]">
                        {!! $body !!}
                    </div>
                </div>
            </div>
            ...
            <aside class="lg:col-span-4 lg:sticky lg:top-[100px]">
                <div class="bg-white border border-[#E9E9E8] rounded-3xl p-6 md:p-8 shadow-sm flex flex-col gap-6">
                    <div>
                        <h2 class="text-xl font-semibold text-[#37352F] tracking-tight">{{ $sidebarTitle ?? 'Detail Artikel' }}</h2>
                    ...
                    <div class="space-y-4 border-y border-[#E9E9E8] py-5">
                        ...
                        @if ($updatedText !== '' && $updatedText !== $publishedText)
                            <div class="flex items-start justify-between gap-4">
                                <div>
                                    <p class="text-xs font-semibold uppercase tracking-wider text-[#979A9B]">Diperbarui</p>
