...
<x-layouts.marketing :seo="[
    ...
    <x-container>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 pt-12 gap-3">
            <div class="flex flex-col w-full bg-white rounded shadow-lg">
                <div class="w-full h-44 sm:h-64 bg-top bg-cover rounded-t"
                ...
                <div class="flex flex-col w-full md:flex-row">
                    ...
                    <div class="p-4 font-normal text-gray-800">
                        <h1 class="mb-4 text-xl sm:text-3xl font-bold leading-none tracking-tight text-gray-800">2020
                            National
                            Championship
                        </h1>
