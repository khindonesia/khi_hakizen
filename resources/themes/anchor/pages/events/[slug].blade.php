        ...
        <x-container>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
                ...
                <div class="lg:col-span-8 flex flex-col gap-6">
                    ...
                    <!-- Cover Image -->
                    <div
                        class="relative bg-zinc-100 rounded-3xl overflow-hidden shadow-sm border border-[#E9E9E8] aspect-[16/9]">
                        @php
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2 mb-3">
                            <span
                                class="bg-[#f9f1fc] text-[#df1c24] text-xs font-bold px-3 py-0.5 rounded-full uppercase tracking-wider">
                                KHI Heritage Program
                            </span>
                            @if ($isOngoing)
                                <span
                                    class="bg-indigo-50 text-indigo-700 text-xs font-bold px-3 py-0.5 rounded-full uppercase tracking-wider">Ongoing</span>
                            @elseif($isUpcoming)
                                <span
                                    class="bg-emerald-50 text-emerald-700 text-xs font-bold px-3 py-0.5 rounded-full uppercase tracking-wider">Upcoming</span>
                            @else
                                <span
                                    class="bg-zinc-100 text-zinc-600 text-xs font-bold px-3 py-0.5 rounded-full uppercase tracking-wider">Past
                                    Event</span>
                            @endif
                        </div>

                        <h1
                            class="text-2xl md:text-[36px] font-semibold text-[#37352F] tracking-tight leading-tight mb-4">
                            {{ $event->title }}
                        </h1>
                        ...
                        <div class="flex items-center gap-3 border-y border-[#E9E9E8]/50 py-3 mt-4">
                            <div
                                class="w-8 h-8 rounded-full bg-[#fef2f2] flex items-center justify-center text-[#df1c24] font-bold text-xs">
                                {{ substr($event->author->name ?? 'KHI', 0, 1) }}
                            </div>
                            <div>
                                <p class="text-xs text-[#37352F] font-semibold">Organized by
                                    {{ $event->author->name ?? 'KHI Team' }}</p>
                                <p class="text-[10px] text-[#979A9B] uppercase tracking-wider font-semibold mt-0.5">
                                    Community Curator</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        class="prose prose-zinc max-w-none text-[#575e75] leading-[1.7] mt-2 prose-headings:text-[#37352F] prose-headings:font-semibold prose-a:text-[#df1c24] prose-strong:text-[#37352F] font-normal">
                        {!! clean($event->body) !!}
                    </div>
                ...
                <aside class="lg:col-span-4 lg:sticky lg:top-[100px]">
                    <div
                        class="bg-[#fff5f5] rounded-2xl p-6 md:p-8 shadow-sm border border-[#E9E9E8] flex flex-col gap-6">

                        <div>
                            <h2 class="text-xl font-semibold text-[#37352F] tracking-tight">Event Details</h2>
                            <p class="text-xs text-[#979A9B] mt-0.5">Please review the agenda and timing details below.
                            </p>
                        </div>
                        ...
                        <div class="space-y-4 py-4 border-y border-[#E9E9E8]">
                            ...
                            <div class="flex gap-3">
                                <span class="material-symbols-outlined text-[#df1c24] text-[20px] mt-0.5"
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-[#575e75] mt-0.5">
                                        {{ $event->start_datetime->format('l, d F Y') }}</p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-[#575e75] mt-0.5">
                                        {{ $event->location ?? 'Kota Tua Jakarta, Special Capital Region of Jakarta' }}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="flex gap-3">
                                ...
                                <div>
                                    ...
                                    @if (($event->type ?? 'FREE') === 'PAID')
                                        <p class="text-xs text-amber-600 font-semibold mt-0.5">Rp
                            ...
                            @if ($isUpcoming || $isOngoing)
                                        ...
                                        @else
                                            <a href="{{ route('events.checkout', ['event' => $event->id]) }}" wire:navigate
                                                ...
                                                <span class="material-symbols-outlined text-[18px]"
                                                    style="color: white !important;">add_circle</span>
                                                RSVP & Join Event
                                            </a>
                                        @endif
                                    @else
                                        ...
                                        <a href="{{ route('settings.profile') }}" wire:navigate
                                            class="w-full bg-amber-600 hover:bg-amber-700 text-center text-sm font-semibold py-3.5 rounded-lg transition-all flex items-center justify-center gap-1.5 shadow-sm"
                                            style="color: white !important;">
                                            <span class="material-symbols-outlined text-[18px]"
                                                style="color: white !important;">verified_user</span>
                                ...
                                @else
                                    <a href="{{ route('join') }}"
                                        ...
                                        style="color: white !important;">
                                        <span class="material-symbols-outlined text-[18px]"
                                            style="color: white !important;">workspace_premium</span>
