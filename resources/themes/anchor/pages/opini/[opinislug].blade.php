            ...
            <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                ...
                <div class="md:grid md:grid-cols-2 md:gap-10 lg:gap-16 md:items-center">
                    <div class="hidden md:block mb-24 md:mb-0 sm:px-6">
                        <div class="relative">
                            <img class="rounded-xl" src="{{ Storage::url('/' . $opini->user->avatar) }}" alt="Avatar">
                            <!-- SVG Element -->
                            ...
                            <footer class="mt-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="ms-4 md:ms-0">
                                        <div class="text-base font-semibold text-gray-800">{{ $opini->user->name }}
                                        </div>
                                        <div class="text-xs text-gray-500">{{ $user['what-do-you-do-for-a-living'] }}
                                        </div>
                                    </div>
                                </div>
                            </footer>
        ...
        <div class="border-t border-zinc-200 py-4">
            <article id="opini-{{ $opini->id }}"
                ...
                <meta property="dateModified"
                    content="{{ Carbon\Carbon::parse($opini->updated_at)->toIso8601String() }}">
