...
$carts = \App\Models\Cart::paginate(5);
?>
                                ...
                                <div class="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                    ...
                                    <div class="flex items-center justify-between md:order-3 md:justify-end">
                                        ...
                                        <div class="text-end md:order-4 md:w-32">
                                            <p class="text-base font-bold text-gray-900 dark:text-white">Rp15.000.000</p>
                                        </div>
                                    </div>
                    ...
                    <div
                        ...
                        <div class="space-y-4">
                            ...
                            <dl
                                ...
                                <dd class="text-base font-bold text-gray-900 dark:text-white">Rp0</dd>
                            </dl>
                        </div>
