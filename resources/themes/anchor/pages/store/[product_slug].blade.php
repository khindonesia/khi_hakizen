...
<x-layouts.marketing>
                ...
                <div class="mt-6 sm:mt-8 lg:mt-0">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="flex items-center">
                            <button type="button" id="decrease-quantity" class="p-2 border border-gray-300 rounded-l-md hover:bg-gray-100">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 12H4" />
                                </svg>
                            </button>
                            <input type="number" id="quantity" min="1" value="1" class="p-2 w-16 text-center border-t border-b border-gray-300 focus:outline-none focus:ring-primary-500" />
                            <button type="button" id="increase-quantity" class="p-2 border border-gray-300 rounded-r-md hover:bg-gray-100">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            ...
            <div class="mt-6 divide-y divide-gray-200 dark:divide-gray-700">
                <div class="gap-3 pb-6 sm:flex sm:items-start">
                    <div class="shrink-0 space-y-2 sm:w-48 md:w-72">
                        ...
                        <div class="space-y-0.5">
                            ...
                            <p class="text-sm font-normal text-gray-500 dark:text-gray-400">November 18 2023 at 15:35
                            </p>
                        </div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex items-center">
                                ...
                                <label for="reviews-radio-1"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Yes: 3 </label>
                            </div>
                            <div class="flex items-center">
                ...
                <div class="gap-3 py-6 sm:flex sm:items-start">
                    ...
                    <div class="mt-4 min-w-0 flex-1 space-y-4 sm:mt-0">
                        <p class="text-base font-normal text-gray-500 dark:text-gray-400">I replaced my 11 year old
                            iMac with the new M1 Apple. I wanted to remain with Apple as my old one is still working
    ...
    <script>
        // Variant and attribute selection system
        document.addEventListener('DOMContentLoaded', function() {
            ...
            currentVariant = {
                ...
                image_url: @if($defaultVariant->image_url) "{{ Storage::url('/' . $defaultVariant->image_url) }}" @else null @endif
            };
            @endif
            ...
            if (currentVariant) {
                ...
                Object.entries(defaultAttributes).forEach(([attributeId, valueId]) => {
                    const button = document.querySelector(`button[data-attribute-id="${attributeId}"][data-value-id="${valueId}"]`);
                    if (button) {
            ...
            attributeSelectors.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    const siblings = document.querySelectorAll(`button[data-attribute-id="${attributeId}"]`);
                    ...
                    const selections = {};
                    document.querySelectorAll('.attribute-selector.bg-primary-100').forEach(selected => {
            ...
            addToCartBtn.addEventListener('click', function() {
                ...
                // Here you would typically handle adding to cart
                // For example, make an AJAX request to your cart controller
