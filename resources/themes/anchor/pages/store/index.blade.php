...
$products = \App\Models\Product::leftJoin('variants', 'products.id', '=', 'variants.product_id')
...
<x-layouts.marketing :seo="[
    ...
    <x-container class="py-8 md:py-16">
    ...
    <div class="bg-gray-50 py-8 antialiased md:py-12">
        <x-container>
            <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
                ...
                <div class="mb-4 grid gap-1 grid-cols-2 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
                    @foreach ($products as $product)
                        <div
                        class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                            <div class="h-26 sm:h-56 w-full">
                                <a href="#">
                            ...
                            <div class="pt-6">
                                ...
                                <div class="mt-2 flex items-center gap-2">
                                    <div class="flex items-center">
                                        ...
                                        <svg class="h-4 w-4 text-yellow-400 hidden sm:block" aria-hidden="true"
                                            xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                                            <path
                                                d="M13.8 4.2a2 2 0 0 0-3.6 0L8.4 8.4l-4.6.3a2 2 0 0 0-1.1 3.5l3.5 3-1 4.4c-.5 1.7 1.4 3 2.9 2.1l3.9-2.3 3.9 2.3c1.5 1 3.4-.4 3-2.1l-1-4.4 3.4-3a2 2 0 0 0-1.1-3.5l-4.6-.3-1.8-4.2Z" />
                                        </svg>
                                ...
                                {{-- <div class="mt-4 flex items-center justify-between gap-4">
                                    <p class="text-sm sm:text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">Rp15.000.000</p>

                                    <button type="button"
                                        class="inline-flex items-center rounded-lg bg-primary-700 px-3 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300">
                                ...
                                <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                                    ...
                                    <div class="space-y-3">
                                        <div>
                                            ...
                                            <input id="min-delivery-time" type="range" min="3"
                                                max="50" value="30" step="1"
                                                class="h-2 w-full cursor-pointer appearance-none rounded-lg bg-gray-200 dark:bg-gray-700" />
                                        </div>

                                        <input type="number" id="min-delivery-time-input" value="30"
                                            min="3" max="50"
                                            class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-primary-500 dark:focus:ring-primary-500 "
                                            placeholder="" required />
                                    </div>
                                    ...
                                    <ul class="grid grid-cols-2 gap-4">
                                        <li>
                                            <input type="radio" id="delivery-usa" name="delivery"
                                                value="delivery-usa" class="peer hidden" checked />
