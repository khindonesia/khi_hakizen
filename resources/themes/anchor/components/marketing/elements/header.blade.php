        ...
        <div class="z-30 flex items-center justify-between h-20 md:space-x-8">
            ...
            <nav :class="{
                ...
                <ul :class="{
                    ...
                    <li class="flex-shrink-0 h-16 border-b border-gray-100 md:border-b-0 md:h-full">
                        <a href="{{ url('historia-news') }}" wire:navigate
                            class="flex items-center h-full text-sm font-medium text-gray-700 transition duration-300 md:px-0 px-7 hover:bg-gray-100 md:hover:bg-transparent hover:text-gray-900 {{ request()->is('historia-news') ? 'font-semibold' : 'font-medium' }}">
                            Historia News
                        </a>
                    </li>
                    <li class="flex-shrink-0 h-16 border-b border-gray-100 md:border-b-0 md:h-full">
                    ...
                    <li class="flex-shrink-0 h-16 border-b border-gray-100 md:border-b-0 md:h-full">
                        <a href="{{ route('library') }}" wire:navigate
                            class="flex items-center h-full text-sm font-medium text-gray-700 transition duration-300 md:px-0 px-7 hover:bg-gray-100 md:hover:bg-transparent hover:text-gray-900 {{ request()->routeIs('library') || request()->routeIs('library.book') ? 'font-semibold' : 'font-medium' }}">
                            E-Library
                        </a>
                    </li>
                    {{-- <li class="flex-shrink-0 h-16 border-b border-gray-100 md:border-b-0 md:h-full">
