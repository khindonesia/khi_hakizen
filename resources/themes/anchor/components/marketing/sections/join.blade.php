@php
    $homePageContent = \App\Models\HomePageContent::with('achievements')->first();
    $achievements = $homePageContent ? $homePageContent->achievements()->ordered()->get() : collect();
@endphp
...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
        <div>
            <img class="rounded-xl" src="{{ Storage::url($homePageContent->leader_image) }}" alt="Leader Image">
        </div>
        <!-- End Col -->
